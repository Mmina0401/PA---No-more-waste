...
if (
    ...
    if ($idUtilisateur <= 0) {
        $error = "Identifiant du bénévole invalide.";
    } else {
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 p-4">
            ...
            <p class="text-muted">
                Consultez et gérez les informations, compétences et statuts des bénévoles.
            </p>
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <?php foreach ($benevoles as $benevole): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (
                                        !empty($benevole["competences"]) &&
                                        is_array($benevole["competences"])
                                    ): ?>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex gap-2 flex-wrap">
                                        ...
                                        <form
                                            method="post"
                                            class="d-inline"
                                            onsubmit="return confirm('Voulez-vous vraiment supprimer ce bénévole ? Cette action est définitive.');"
                                        >
                                            <input
                                                type="hidden"
                                                name="action"
...
function ouvrirModification(benevole) {
    ...
    checkboxes.forEach(function(checkbox) {
        ...
        if (Array.isArray(benevole.competences)) {
            checkbox.checked =
