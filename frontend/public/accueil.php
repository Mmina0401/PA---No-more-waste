...
$estConnecte = isset($_SESSION["jeton"]);
...
.nmw-card.services::after {
    background: var(--nmw-green);
}

.nmw-card.collecte::after {
    background: var(--nmw-blue);
}

.nmw-card.benevole::after {
...
<a
    href="demande-collecte.php"
    class="nmw-btn nmw-btn-secondary"
>
    <span>
        <?= t("home_collection_button") ?>
    </span>
...
<div class="text-center mt-3">
    <small class="text-muted">
        Pas encore bénévole ?
        <a href="/public/candidature-benevole.php">
            Créer une candidature
        </a>
    </small>
</div>

<?php elseif ($role === "BENEVOLE"): ?>
